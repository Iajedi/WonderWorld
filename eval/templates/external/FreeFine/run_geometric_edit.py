"""Thin GeoBench launcher for FreeFine checkout.

Delegates to wonderworld eval.runners.run_geometric_edit with method=freefine.
"""
...
def _resolve_repo_root() -> Path:
    ...
    # eval/external/FreeFine/run_geometric_edit.py -> repo root
    return Path(__file__).resolve().parents[3]


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run GeoBench geometric editing with FreeFine (wonderworld runner)"
    )
    parser.add_argument("--method", type=str, default="freefine")
